...
\def\M{\only<8->{\color{gray}}}
\def\MM#1{\colorlet{@mixn}{black}\only<8->{\colorlet{@mixn}{gray}}\begin{colormixin}{0!@mixn}#1\end{colormixin}}% i dunno, semes to look nice
\def\Q{\only<7->}
\begin{frame}[fragile]{Running the Example}
...
\midrule
25621 & \M25618 &  7 & \Q{\MM{\bbash{/bin/bash -c java -jar producer.jar 1000000 | java -jar consumer.jar | java -jar accountant.jar}}} \\
\Q{\M25622} & \Q{25621}  &  \Q{\M2} & \Q{\K{\bbash{java -jar producer.jar 1000000}}} \\
\Q{\M25623} & \Q{25621}  &  \Q{ 14} & \Q{\K{\bbash{java -jar consumer.jar}}} \\
\Q{\M25624} & \Q{25621}  &  \Q{ 13} & \Q{\K{\bbash{java -jar accountant.jar}}} \\
\Q{\M25738} & \Q{\M5113} &  \Q{\M9} & \Q{\MM{\bbash{ps -o pid,ppid,cpuid,cmd}}} \\
   \end{tabular}};}
\end{tikzpicture}
\end{onlyenv}
