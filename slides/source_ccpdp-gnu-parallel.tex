...
{
\lstset{add to literate={\$SERVER}{{{\color{gray}\textdollar SERVER}}}7 {\$SERVER1}{{{\color{gray}\textdollar SERVER1}}}7}
\begin{frame}[fragile]{Distributed}
   GNU \LogoParallel can run jobs on remote servers. It uses ssh to communicate with the remote machines.\\
   \begin{minted}{bash}
