...
\scope[shift={(current page.north east)},shift={(-4cm,-2cm)},codeouthl,xscale=2,K/.style={circle,fill,scale=1.25},scale=.5,every ndoe/.append style={transform shape}]
      ...
      \node[K,codeouthl!60!white] (2) at (1,0) {};
      {\only<14|handout:3>{\color{shadeA}}
         \node[K] (3a) at (2,2) {};
         \node[K] (3b) at (2,1) {};
         \node[K] (3c) at (2,0) {};
         \node[K] (3d) at (2,-1) {};
      ...
      {\only<15-17|handout:4>{\color{shadeA}}
         \node[K] (4) at (3,0) {};
      }
...
\begin{frame}[fragile]{Data Encoding}
   \begin{itemize}[<+(1)->]
      ...
      \end{itemize}
      \item Exemplified with \link{https://github.com/EagleoutIce/ccpdp-lightning-ss22-gnu-parallel/blob/main/example\%20object\%20and\%20js/java-side/src/main/java/de/uulm/ccpdp/lt/ff/Consumer.java}{Consumer.java}
      % TODO:
