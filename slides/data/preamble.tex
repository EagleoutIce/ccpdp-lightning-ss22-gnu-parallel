...
\NewEnviron{cut-from-main}{\edef\insertframenumber{\the\numexpr\insertframenumber+1}}
...
\BeforeBeginEnvironment{frame}{\colorlet{btdl@color@background}{lightgray}%
\setbeamercolor{background canvas}{bg=btdl@color@background}}
\AfterEndEnvironment{frame}{\colorlet{btdl@color@background}{btdl@color@primary!1!}%
\setbeamercolor{background canvas}{bg=btdl@color@background}}
}{%
\endgroup
}
